...
const knowledge = {
  ...
  plugin: 'Free TYROOM reverb: Room-to-Hall algorithm, decay + pre-delay, 3-band EQ, analog preamp, animated UI, Sheng/Swahili interface. Also includes TYMLAPSE delay. Download free from the Plugin section.',
...
const sheng = {
  ...
  plugin: 'Free TYROOM reverb: Room→Hall algorithm, decay + pre-delay, 3-band EQ, analog preamp, animated UI, na Sheng/Swahili interface. Also iko TYMLAPSE delay plugin. Download free from Plugin section.',
